...
class ImapFlow extends EventEmitter {
     ...
     * @property {boolean | FetchQuerySourceObject} [source] if `true` then include full message in the response
     ...
     */
      ...
      /**
     * @typedef {Object} FetchQuerySourceObject
     * @global
     * @property {Number} [start] include full message in the response starting from *start* byte
     * @property {Number} [maxLength] include full message in the response, up to *maxLength* bytes
     */
     ...
     * @returns {AsyncGenerator<FetchMessageObject>} Message data object
     *
     * @example
     * let mailbox = await client.mailboxOpen('INBOX');
